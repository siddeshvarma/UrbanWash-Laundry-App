...
// --- EDITED: This is now a standalone Application ---
public class LaundryLoginPage extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Node loginCard = createLoginPanel(primaryStage);
        ...
        primaryStage.setTitle("UrbanWash - Business Login");
    ...
    private Node createLoginPanel(Stage primaryStage) {
        VBox loginBox = new VBox(15);
        loginBox.setMaxSize(420, 580);
        ...
        Label instruction = new Label("Log in to manage your shop's operations.");
        ...
        emailLabel.setTextFill(Color.web("#E5E7EB"));
        ...
        passwordLabel.setTextFill(Color.web("#E5E7EB"));
        ...
        rememberMe.setFont(Font.font("System", 13));
        rememberMe.setTextFill(Color.web("#D1D5DB"));
        ...
        // Login Button
        Button loginButton = new Button("Login Securely");
        ...
        loginButton.setOnAction(e -> {
            ...
            showStatus(statusLabel, "Logging in...", true);
            ...
            new Thread(() -> {
                ...
                Platform.runLater(() -> {
                    ...
                    if (loginResult.equals("Success")) {
                        ...
                        try {
                            new BusinessDashboard().start(primaryStage);
                        } catch (Exception ex) {
                            ex.printStackTrace();
                        }
                    } else {
                        showStatus(statusLabel, "Login failed: " + loginResult, false);
                    }
                });
            }).start();
        });
        ...
        signUpPrompt.setFont(Font.font("System", 13));
        signUpPrompt.setTextFill(Color.web("#D1D5DB"));
        Hyperlink signUpLink = new Hyperlink("Register Now");
        signUpLink.setFont(Font.font("System", FontWeight.SEMI_BOLD, 13));
        signUpLink.setTextFill(Color.web("#C7D2FE"));
        signUpLink.setOnAction(e -> new Home().start(primaryStage));
        ...
        loginBox.getChildren().addAll(
            ...
            new VBox(5, emailLabel, styledEmailField),
            new VBox(5, passwordLabel, styledPasswordField),
            optionsBox, statusLabel, loginButton, new Separator(), signUpBox
        );
        return loginBox;
    }
